import { WAITING, COUNTDOWN, PAUSE, PLAYING, EATEN_PAUSE, DYING, Pacman, KEY } from './constants.js';
...
export default class Game extends GameMechanics {
  ...
  mainLoop() {
    ...
    } else if (this.state === EATEN_PAUSE && this.tick - this.timerStart > Pacman.FPS / 3) {
      this.map.draw(this.ctx);
